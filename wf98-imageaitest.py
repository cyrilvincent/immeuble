...
detector.setModelPath("res/yolo.h5")
detector.loadModel()
detections = detector.detectObjectsFromImage(input_image="res/image2.jpg", output_image_path="res/image2new.jpg", minimum_percentage_probability=30)
