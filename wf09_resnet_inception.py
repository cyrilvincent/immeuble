...
def train():
    model = tensorflow.keras.applications.inception_resnet_v2.InceptionResNetV2(include_top=False, weights="imagenet", input_shape=(299, 299, 3))
    model.summary()
    ...
    model.save(f'data/{feature}/inceptionresnetmodel.h5')
    # batch=16
